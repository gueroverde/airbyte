...
class S3DataLakeSpecification :
    ...
    // Default 2
    @get:JsonProperty("max_message_queue_memory_use_ratio") val maxMessageQueueMemoryUseRatio: Double? = null
    @get:JsonProperty("num_workers", defaultValue = "2") val numWorkers: Int? = null
}
