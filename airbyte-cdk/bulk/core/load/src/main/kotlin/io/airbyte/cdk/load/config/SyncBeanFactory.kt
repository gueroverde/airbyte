...
class SyncBeanFactory {
    ...
    /**
     * If the client uses a new-style LoadStrategy, then we need to checkpoint by checkpoint
     * id instead of record index.
     */
    @Singleton @Named("checkpointById") fun isCheckpointById(
        loadStrategy: LoadStrategy? = null
    ): Boolean = loadStrategy != null
